...
def killMonkeyTestProcess(deviceid):
    ...
    commandLine(killMonkeyTestProcess_cmd).wait()
        
#Definition for result save
def monkeytest(createtime,deviceid,runtime,gettime):
    ...
    commandLine(deviceReboot_cmd).wait()
    ...
    if adbstate(deviceid)=="device":
        ...
        commandLine(saveMemoryInfoBeforeTest).wait()
        ...
        for i in range(runcount-1):
            ...
            commandLine(saveMemoryInfo_cmd).wait()
            try:
            ...
            commandLine(killAllBackgroundApps_cmd).wait()
            ...
            commandLine(saveMemoryInfoAfterClearProcess_cmd).wait()
