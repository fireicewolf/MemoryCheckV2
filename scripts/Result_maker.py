...
def resultMaker(savepath):
    ...
    for dirpath,dirnames,filenames in os.walk(dumpsyslogs):
        for dirname in dirnames:
            ...
            titleFormat=workbook.add_format({'font_name': 'Arial','font_size':18,'bold':True,'bg_color':'#00B0F0','align':'center','valign':'vcenter','border':1})
            greenTitleFormat=workbook.add_format({'font_name': 'Arial','font_size':11,'align':'center','valign':'vcenter','border':1,'bg_color':'#92D050'})
            greenTitleNumFormat=workbook.add_format({'font_name': 'Arial','font_size':11,'align':'center','valign':'vcenter','border':1,'bg_color':'#92D050','num_format':'0.00'})
            yellowTitleFormat=workbook.add_format({'font_name': 'Arial','font_size':11,'align':'center','valign':'vcenter','border':1,'bg_color':'#FFC000','bold':True})
            greyTitleFormat=workbook.add_format({'font_name': 'Arial','font_size':11,'align':'center','valign':'vcenter','border':1,'bg_color':'#A6A6A6'})
            defaultCellFormat=workbook.add_format({'font_name': 'Arial','font_size':11,'align':'center','valign':'vcenter','border':1})
            numCellFormat=workbook.add_format({'font_name': 'Arial','font_size':11,'align':'center','valign':'vcenter','border':1,'num_format':'0.00'})
            processNameCellFormat=workbook.add_format({'font_name': 'Arial','font_size':11,'valign':'vcenter','border':1})
